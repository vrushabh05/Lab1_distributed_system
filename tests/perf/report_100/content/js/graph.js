...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.76323836E12, "maxY": 1.0903954802259892, "series": [{"data": [[1.76323836E12, 1.0903954802259892], [1.76323842E12, 1.0]], "isOverall": false, "label": "Users", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76323842E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.0, "maxY": 54.0, "series": [{"data": [[1.0, 0.8247422680412371], [3.0, 3.3333333333333335]], "isOverall": false, "label": "Create Booking", "isController": false}, {"data": [[1.0600000000000005, 0.9000000000000001]], "isOverall": false, "label": "Create Booking-Aggregated", "isController": false}, {"data": [[1.0, 0.0], [3.0, 0.0]], "isOverall": false, "label": "Search Properties", "isController": false}, {"data": [[1.0600000000000005, 0.0]], "isOverall": false, "label": "Search Properties-Aggregated", "isController": false}, {"data": [[2.0, 54.0], [1.0, 1.3195876288659791], [3.0, 2.0]], "isOverall": false, "label": "Login", "isController": false}, {"data": [[1.0399999999999998, 2.379999999999999]], "isOverall": false, "label": "Login-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 3.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 390.18333333333334, "minX": 1.76323836E12, "maxY": 1922.4166666666667, "series": [{"data": [[1.76323836E12, 1922.4166666666667], [1.76323842E12, 1335.9166666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.76323836E12, 561.4833333333333], [1.76323842E12, 390.18333333333334]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76323842E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76323836E12, "maxY": 3.0847457627118637, "series": [{"data": [[1.76323836E12, 1.016949152542373], [1.76323842E12, 0.7317073170731708]], "isOverall": false, "label": "Create Booking", "isController": false}, {"data": [[1.76323836E12, 0.0], [1.76323842E12, 0.0]], "isOverall": false, "label": "Search Properties", "isController": false}, {"data": [[1.76323836E12, 3.0847457627118637], [1.76323842E12, 1.3658536585365852]], "isOverall": false, "label": "Login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76323842E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76323836E12, "maxY": 2.864406779661016, "series": [{"data": [[1.76323836E12, 0.9661016949152542], [1.76323842E12, 0.6829268292682926]], "isOverall": false, "label": "Create Booking", "isController": false}, {"data": [[1.76323836E12, 0.0], [1.76323842E12, 0.0]], "isOverall": false, "label": "Search Properties", "isController": false}, {"data": [[1.76323836E12, 2.864406779661016], [1.76323842E12, 1.2682926829268295]], "isOverall": false, "label": "Login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76323842E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76323836E12, "maxY": 1.7966101694915242, "series": [{"data": [[1.76323836E12, 0.0], [1.76323842E12, 0.0]], "isOverall": false, "label": "Create Booking", "isController": false}, {"data": [[1.76323836E12, 0.0], [1.76323842E12, 0.0]], "isOverall": false, "label": "Search Properties", "isController": false}, {"data": [[1.76323836E12, 1.7966101694915242], [1.76323842E12, 0.5609756097560976]], "isOverall": false, "label": "Login", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76323842E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76323836E12, "maxY": 54.0, "series": [{"data": [[1.76323836E12, 54.0], [1.76323842E12, 2.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.76323836E12, 2.0], [1.76323842E12, 2.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.76323836E12, 54.0], [1.76323842E12, 2.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.76323836E12, 2.049999999999997], [1.76323842E12, 2.0]], "isOverall": false, "label": "95th percentile", "isController": false}, {"data": [[1.76323836E12, 0.0], [1.76323842E12, 0.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.76323836E12, 1.0], [1.76323842E12, 1.0]], "isOverall": false, "label": "Median", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76323842E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 0.0, "minX": 3.0, "maxY": 2.0, "series": [{"data": [[3.0, 1.0], [27.0, 2.0], [30.0, 1.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[3.0, 0.0], [27.0, 0.0], [30.0, 0.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 30.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 0.0, "minX": 3.0, "maxY": 2.0, "series": [{"data": [[3.0, 1.0], [27.0, 2.0], [30.0, 1.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[3.0, 0.0], [27.0, 0.0], [30.0, 0.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 30.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 2.05, "minX": 1.76323836E12, "maxY": 2.95, "series": [{"data": [[1.76323836E12, 2.95], [1.76323842E12, 2.05]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76323842E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
