              ...
              <>
                {user?.role === 'TRAVELER' && (
                  <>
                    ...
                    <Link
                      to="/favorites"
                      className={`flex items-center gap-2 text-sm font-semibold transition-colors ${isActive('/favorites')
                          ? 'text-[var(--color-primary)]'
                          : 'text-[var(--color-charcoal)] hover:text-[var(--color-ink)]'
                        }`}
                    >
          ...
          <div className="flex items-center gap-4">
            {!isAuthenticated ? (
              ...
              <div className="relative">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[var(--color-accent)] to-[var(--color-accent-dark)] flex items-center justify-center text-white font-semibold text-sm">
                        ...
                        {user?.role === 'TRAVELER' && (
                          <>
                            ...
                            >
                              ...
                              <span className="font-medium text-[var(--color-ink)]">My Trips</span>
                            </button>
                            <button
                              onClick={() => {
                                navigate('/favorites')
                            ...
                            >
                              ...
                              <span className="font-medium text-[var(--color-ink)]">Favorites</span>
                            </button>
                          </>
                        )}
